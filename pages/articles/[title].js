  ...
  return (
    <>
      <Head>
        ...
        <link rel="alternate" hrefLang="en" href={WEBSITE_BASE_URL + `/${blogData.title}`} />
        <link rel="alternate" hrefLang="x-default" href={WEBSITE_BASE_URL + `/${blogData.title}`} />
        <link rel="alternate" hrefLang="ar" href={WEBSITE_BASE_URL + `/ar/${blogData.title}`} />
        ...
        <meta name="twitter:image" content={BLOG_IMAGE_BASE_URL + metaImage} />
        <script
              ...
              <div className="flex flex-col lg:flex-row gap-4 mt-12 lg:px-0">
                  ...
                  <div className="w-full lg:w-4/5 lg:ltr:border-r lg:rtl:border-l border-gray-300 px-0 ltr:lg:pr-6 rtl:lg:pl-6">
                    ...
                    <div className="pb-8">
                      <div className="flex flex-col mb-16 gap-2">
                        <h2 className="text-black font-bold text-2xl ">Tags</h2>
                        <div className="flex flex-wrap gap-1">
                          {blogData?.tag?.split(",").map((tag) => {
                            return (
                              <div className="bg-[#095668] text-white rounded-full px-4 py-1">
                                {"#" + tag}
                              </div>
                            );
                          })}
                      ...
                      <div className="text-xl uppercase font-heading">
                        {t("pages.blog.share") + " :"}
                      </div>
                      <div className="mt-5">
                ...
                {relatedProperties.length > 0 && (
                  <div className="w-full lg:w-2/5 px-2 mx-auto mb-10">
                    <h2 className="w-full text-2xl mb-6 font-bold leading-10 text-center uppercase font-heading">
